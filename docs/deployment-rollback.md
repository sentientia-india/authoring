...
3. builds the candidate containers under the stable Compose project name;
...
If any build, migration, startup, health, or smoke command fails, the error trap rebuilds and restarts the previous release. The `current` symlink remains unchanged.
