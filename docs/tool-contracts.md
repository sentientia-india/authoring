...
Supported export formats: `scorm`, `h5p`. Visual editing of exported courses happens in the bundled WYSIWYG editor (see docs/editor-setup.md), which renders the actual course player as its canvas.
